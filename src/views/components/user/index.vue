<template>
    <div class="roles">
        ...
        <component-table :data="tableData">
            ...
            <template v-slot:realName="{scope}"> <el-input v-model="scope.row.realName" @blur="handleRealNameBlur(scope.row)" size="mini" ></el-input> </template> 
...
export default {
    ...
    methods: {
        ...
        // 18点59分
        handleRealNameBlur(row) {
            this.request(edit,row,this,data => {
        ...
        labelInit(){
            this.tableData.tableLabel = [
                ...
                {prop:'realName',title:'真实姓名',slot:'realName'},
